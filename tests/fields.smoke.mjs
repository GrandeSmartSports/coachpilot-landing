...
for (const [s, why] of [
  ...
  ['id="hgNotify"', 'set-PIN success offers a one-tap "alert the league" link'],
  ['function notifyNoLink', 'notifyNoLink auto-alerts the league when the sign-in link is not received'],
